-- Inserts nas tabelas do banco de dados
INSERT INTO TB_CUSTOMER (cpf, password, email, first_name, last_name, age)
VALUES 
	('11111111111', '123', 'bernardo@gmail.com.br', 'Bernardo', 'Pereira', 20),
  ('22222222222', '123', 'breno@gmail.com.br', 'Breno', 'Pereira', 12),
  ('33333333333', '123', 'bruno@gmail.com.br', 'Bruno', 'Pereira', 18),
  ('44444444444', '123', 'alfredo@gmail.com.br', 'Alfredo', 'Pereira', 45);
...
INSERT INTO TB_ORDER (num_order, date_order, qtda_products, total_order, id_customer, id_transaction, status_payment, method_payment)
VALUES
	(1, '2024-10-10 10:15:00', 3, 100.50, 1, '123456', 'pago', 'cartão de crédito'),
  (2, '2024-10-12 10:15:00', 7, 300.50, 2, '123456', 'pago', 'cartão de crédito'),
  (3, '2024-10-15 10:15:00', 6, 500.50, 3, '123456', 'pago', 'cartão de crédito'),
  (4, '2024-10-17 10:15:00', 2, 150.50, 4, '123456', 'pago', 'cartão de crédito');
