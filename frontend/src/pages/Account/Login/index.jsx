...
function Register() {
	...
	function handleValidateFields(values) {
		...
		if (!values.senha) {
			errors.senha = "campo obrigatorio de ser preenchido";
		} else if (values.senha.length > 30) {
			errors.senha = "insira menos de 30 caracteres";
		}
	...
	return (
		<main className="sn__account-login">
			<div className="sn__account-login-wrapper">
				...
				<form
					method="POST"
					className="sn__account-login-form"
